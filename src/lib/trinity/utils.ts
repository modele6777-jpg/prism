...
- [방향과 결단] ${binaryPick ? `최종 선택은 [${binaryPick.chosen}]이며, 확신을 갖고 나아가는 것이 운을 여는 열쇠입니다.` : analysis.kind === 'yes_no' ? '최종 판정은 [결단이 필요한 YES]이며, 주저하지 말고 준비해 온 마음을 믿고 한 걸음 내딛으셔도 좋습니다.' : '운의 흐름은 정체를 지나 도약과 확신의 타이밍을 명확히 가리키고 있습니다.'}
