...
export function BigBangButton() {
  ...
  const activeAppName = (() => {
    ...
    if (isOrbSite) return '프리즘 귀환 (Key 나가기)';
    // 🔮 제자리 홀드 - 프리즘 페이지에서는 크리스탈 Key 입장
    return '크리스탈 Key (입장)';
  })();
        ...
        >
          ...
          <div className="relative w-[76px] h-[76px] sm:w-[84px] sm:h-[84px] flex items-center justify-center shrink-0">
            ...
            <motion.button
              ...
              aria-label={
                hasSelectionToss
                  ? `빅뱅 버튼 · 선택 내용 토스 대기중 ("${selectionPreviewText}...") · 탭: 루시 대화 연계, 홀드: 크리스탈 Key 신탁 연계`
                  : isChatView
                  ? '빅뱅 버튼 · 탭: 루시 채팅 닫기, 더블탭: 프리즘 메인, 홀드: 크리스탈 Key, 드래그: 맥락 추천 1위 이동'
                  : isOrbSite
                  ? '빅뱅 버튼 · 탭: 루시 채팅 열기, 더블탭: 프리즘 메인, 홀드: Key 나가기, 드래그: 맥락 추천 1위 이동'
                  : '빅뱅 버튼 · 탭: 루시 채팅, 더블탭: 프리즘 메인, 홀드: 크리스탈 Key 들어가기, 드래그: 맥락 추천 1위 이동'
              }
              title={
                hasSelectionToss
                  ? `[선택 텍스트 토스 대기: "${selectionPreviewText}..."] 탭: 루시 1:1 대화 연계 · 홀드: 크리스탈 Key 직관 신탁 연계 · 드래그: 추천 1위 토스`
                  : isChatView
                  ? '탭: 루시 채팅 닫기 · 더블탭: 프리즘 메인 · 홀드: 크리스탈 Key · 드래그: 맥락 추천 1위 이동 (사이클 순환)'
                  : isOrbSite
                  ? '탭: 루시 채팅 열기 · 더블탭: 프리즘 메인 · 홀드: Key 나가기 · 드래그: 맥락 추천 1위 이동 (사이클 순환)'
                  : '탭: 루시 채팅 · 더블탭: 프리즘 메인 · 홀드: 크리스탈 Key · 드래그: 맥락 추천 1위 이동 (사이클 순환)'
              }
            >
